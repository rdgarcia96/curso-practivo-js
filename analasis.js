...
//const spliceStar = Math.ceil((salariosColSorted.length * 90) / 100);
const spliceStar = parseInt((salariosColSorted.length * 90) / 100);
const spliceCount = salariosColSorted.length - spliceStar;


const salariosTop10 = salariosColSorted.splice(spliceStar, spliceCount);
